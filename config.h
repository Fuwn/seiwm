...
static const Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){MODKEY, XK_0, comboview, {.ui = ~0}},
    ...
    // },
    {MODKEY, XK_e, spawn,
     SHCMD(TERMINAL " -e thunderbird ; pkill -RTMIN+12 dwmblocks")},
    ...
    //  XK_r,
    //  spawn,
    //  {.v = (const char *[]){"rofi", "-show", "run", NULL}}}, /* lfub */
    {MODKEY | ShiftMask,
     XK_r,
     spawn,
    ...
    {MODKEY,
     XK_p,
     spawn,
     {.v = (const char *[]){"spt", "pb", "--toggle", NULL}}}, /* mpc toggle */
    /* { MODKEY|ShiftMask,		XK_p,			spawn,
       SHCMD("mpc pause; pauseallmpv") }, */
    {MODKEY,
     XK_bracketleft,
     spawn,
     {.v = (const char *[]){"spt", "pb", "--seek", "-10",
                            NULL}}}, /* mpc seek -10 */
    {MODKEY | ShiftMask,
     XK_bracketleft,
     spawn,
     {.v = (const char *[]){"spt", "pb", "--seek", "-60",
                            NULL}}}, /* mpc seek -60 */
    {MODKEY,
     XK_bracketright,
     spawn,
    ...
    {MODKEY,
     XK_d,
     spawn,
     {.v = (const char *[]){"rofi", "-show", "combi", NULL}}}, /* dmenu_run */
    {MODKEY | ShiftMask,
     XK_d,
     spawn,
     {.v = (const char *[]){"bitwarden-desktop", NULL}}}, /* passmenu */
    ...
    {MODKEY | ShiftMask, XK_n, spawn,
     SHCMD(BROWSER " https://sumi.news ; pkill -RTMIN+6 dwmblocks")},
    {MODKEY,
     XK_m,
     spawn,
    ...
    {MODKEY,
     XK_comma,
     spawn,
     {.v = (const char *[]){"spt", "pb", "--pp", NULL}}}, /* mpc prev */
    {MODKEY | ShiftMask,
     XK_comma,
     spawn,
     {.v = (const char *[]){"spt", "pb", "--seek", "+10",
    ...
    {MODKEY,
     XK_period,
     spawn,
     {.v = (const char *[]){"spt", "pb", "--next", NULL}}}, /* mpc next */
    {MODKEY | ShiftMask,
     XK_period,
     spawn,
    ...
    {0,
     XF86XK_AudioPrev,
     spawn,
     {.v = (const char *[]){"playerctl", "previous", NULL}}}, /* mpc prev */
    {0,
     XF86XK_AudioNext,
     spawn,
     {.v = (const char *[]){"playerctl", "next", NULL}}}, /* mpc next */
    {0,
     XF86XK_AudioPause,
     spawn,
     {.v = (const char *[]){"playerctl", "play-pause", NULL}}}, /* mpc pause */
    {0,
     XF86XK_AudioPlay,
     spawn,
     {.v = (const char *[]){"playerctl", "play-pause", NULL}}}, /* mpc play */
    {0,
     XF86XK_AudioStop,
     spawn,
     {.v = (const char *[]){"playerctl", "stop", NULL}}}, /* mpc stop */
    {0,
     XF86XK_AudioRewind,
     spawn,
     {.v = (const char *[]){"playerctl", "position", "-10",
                            NULL}}}, /* mpc seek -10 */
    {0,
     XF86XK_AudioForward,
     spawn,
